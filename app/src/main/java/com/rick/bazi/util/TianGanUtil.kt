...
class TianGanUtil {
    ...
    data class TianGanaHeInfo(val srcTgPos : TianGanPos, val srcTg : TianGan, val dstTgPos : TianGanPos, val dstTg : TianGan, val wx :WuXing)
...
//        var heTg = tianGanHeMap.get(tg)
        ...
        if(isTianGanHe(tg, data.monthTiangan)){
            ...
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_YEAR, tg, TianGanPos.TIANGAN_MONTH, data.monthTiangan, wx))
        }
        if(isTianGanHe(tg, data.dayTiangan)){
            wx = tianGanHeWuXingMap.get(tg)!!
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_YEAR, tg, TianGanPos.TIANGAN_DAY, data.dayTiangan, wx))
        }
        if(isTianGanHe(tg, data.hourTiangan)){
            wx = tianGanHeWuXingMap.get(tg)!!
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_YEAR, tg, TianGanPos.TIANGAN_HOUR, data.hourTiangan, wx))
        }

        tg = data.monthTiangan
        if(isTianGanHe(tg, data.dayTiangan)){
            wx = tianGanHeWuXingMap.get(tg)!!
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_MONTH, tg, TianGanPos.TIANGAN_DAY, data.dayTiangan, wx))
        }
        if(isTianGanHe(tg, data.hourTiangan)){
            wx = tianGanHeWuXingMap.get(tg)!!
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_MONTH, tg, TianGanPos.TIANGAN_HOUR, data.hourTiangan, wx))
        }

        tg = data.dayTiangan
        if(isTianGanHe(tg, data.hourTiangan)){
            wx = tianGanHeWuXingMap.get(tg)!!
            heList.add(TianGanaHeInfo(TianGanPos.TIANGAN_DAY, tg, TianGanPos.TIANGAN_HOUR, data.hourTiangan, wx))
        }
